	...
	<footer id="colophon" class="site-footer">
		...
		<div class="container pt-2 pb-2">
			...
			<div class="row d-flex align-items-center">
				<div class="col">
					<p>&copy; <?php bloginfo('name'); ?> <?php echo date('Y')?> / Created by <a href="htttp://nicolas.co.jp" target="_blank">Nicolas</a></p>
				</div>

				<div class="col h-25 d-inline-block text-end">
					 <img loading="lazy" class="img-fluid" src="<?php echo get_template_directory_uri();?>/img/cards.png" alt="payment methods">
				</div>
