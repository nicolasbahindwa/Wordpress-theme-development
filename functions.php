...
// Meta Box Class: MovieAndPostFieldMetaBox
// Get the field value: $metavalue = get_post_meta( $post_id, $field_id, true );
class MovieAndPostFieldMetaBox{
	...
	public function meta_box_callback( $post ) {
		wp_nonce_field( 'MovieAndPostField_data', 'MovieAndPostField_nonce' );
	...
	public function save_fields( $post_id ) {
		if ( ! isset( $_POST['MovieAndPostField_nonce'] ) )
			return $post_id;
		$nonce = $_POST['MovieAndPostField_nonce'];
		if ( !wp_verify_nonce( $nonce, 'MovieAndPostField_data' ) )
			return $post_id;
...
if (class_exists('MovieAndPostFieldMetabox')) {
	new MovieAndPostFieldMetabox;
};
